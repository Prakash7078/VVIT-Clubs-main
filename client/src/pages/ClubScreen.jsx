...
function ClubScreen() {
  ...
  return (
    <div className='lg:pt-24 pt-8 bg-[#fff3e0]'>
       ...
       <div className={`${userInfo.isAdmin || userInfo.category==="Coordinator"?'blur-none':' blur-sm  pb-5 backdrop-brightness-90  pointer-events-none'}`}>
       ...
       <div className={`${userInfo.isAdmin || userInfo.category==="Coordinator"?'hidden':'absolute font-bold lg:text-xl text-brown-400 flex items-center justify-center inset-x-0 inset-y-0'}`}>
          <h1 className='mx-6 text-center'>Only admins and coordinators can see these registartions.</h1>
       </div>
