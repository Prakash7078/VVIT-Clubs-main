...
const About = () => {
  return (
    ...
    <section className="relative w-full bg-[#ffcc80] text-black " id="about">
      <div id="#about" className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 xl:gap-x-20  lg:px-8 xl:px-0 py-5 md:py-5">
        <div className="relative  lg:col-span-5 lg:-ml-8 xl:col-span-5 flex items-center justify-center">
          <img className="h-2/3 w-4/5 xl:w-full object-fill rounded-full xl:rounded-lg" src="https://img.freepik.com/free-vector/employees-meeting-office-kitchen-drinking-coffee_74855-5237.jpg?size=626&ext=jpg&ga=GA1.1.1846821367.1689526579&semt=ais" alt="about us image" />
          {/* <iframe
