    ...
    <div className="bg-[#ffcc80] py-16">
      ...
      <div className="grid grid-cols-1 lg:mx-32 md:mx-10 mt-16 md:grid-cols-2 lg:gap-0 lg:grid-cols-4 gap-14 ">
        ...
        <div className='w-3/4 mx-auto flex flex-col gap-4 items-center'>
          ...
          <p className='leading-normal sm:px-2'>Make sure to check out the list of events with their corresponding details, along with the guest list for everyone to review.</p>
          <button className="font-bold text-lg mt-4" onClick={showEventGuestList}>Start now &gt;</button>
        </div>   
        <div className='w-3/4 mx-auto flex flex-col gap-4 items-center'>
          ...
          <button className="font-bold text-lg mt-4" onClick={showClubDetails}>Start now &gt;</button>
        </div>   
        <div className='w-3/4 mx-auto flex flex-col gap-4 items-center'>
          ...
          <button className="font-bold text-lg mt-4" onClick={showCalender}>Start now &gt;</button>
        </div>   
